...
`.github/workflows/JuliaupPages.yml.template` in this repository is a starting
point: it builds a tarball per platform, attaches them to the release, and
deploys the database to GitHub Pages.
